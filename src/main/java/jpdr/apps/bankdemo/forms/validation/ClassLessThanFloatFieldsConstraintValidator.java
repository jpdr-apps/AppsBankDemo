...
public class ClassLessThanFloatFieldsConstraintValidator
		implements ConstraintValidator<ValidateClassLessThanFloatFields, Object> {

	private String fieldBase;
	private String fieldMatch;

	public void initialize(ValidateClassLessThanFloatFields validateClassLessThanFloatFields) {
		this.fieldBase = validateClassLessThanFloatFields.fieldBase();
		this.fieldMatch = validateClassLessThanFloatFields.fieldMatch();
	}
