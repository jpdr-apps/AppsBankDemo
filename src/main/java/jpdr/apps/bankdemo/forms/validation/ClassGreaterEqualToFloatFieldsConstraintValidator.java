...
public class ClassGreaterEqualToFloatFieldsConstraintValidator
		implements ConstraintValidator<ValidateClassGreaterEqualToFloatFields, Object> {

	private String fieldBase;
	private String fieldMatch;

	public void initialize(ValidateClassGreaterEqualToFloatFields validateClassGreaterEqualToFloatFields) {
		this.fieldBase = validateClassGreaterEqualToFloatFields.fieldBase();
		this.fieldMatch = validateClassGreaterEqualToFloatFields.fieldMatch();
	}
