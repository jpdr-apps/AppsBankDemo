...
<div>
	<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
		...
		<div
			...
			<div style="vertical-align: middle !important">			
				...
				<span class="form-label fs-2"  style="vertical-align: middle !important"> <fmt:message
						key="paymentResults.paymentResults.message" bundle="${messageProperties}" />
				</span>
			 </div>			 
		</div>
		...
		<div class="ps-lg-4 bankdemo-content text-center">		
			...
			<br>
			<span class="form-label fs-6 "><fmt:message key = "paymentResults.submitted.message" bundle = "${messageProperties}"/></span>
			<br>
			<span class="form-label fs-6"><fmt:message key = "paymentResults.paymentId.message" bundle = "${messageProperties}"/>:</span> 
			...
			<br>
			<br>
			<a href="/accounts" class="btn btn-primary"><fmt:message key = "forms.accept.message" bundle = "${messageProperties}"/></a>
		</div>				
	</main>
</div>
