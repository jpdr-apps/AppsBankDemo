...
<div>
	<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
		...
		<div
			...
			<div style="vertical-align: middle !important">			
				...
				<span class="form-label fs-2"  style="vertical-align: middle !important"> <fmt:message
						key="loanPayResults.loanResults.message" bundle="${messageProperties}" />
				</span>
			 </div>					
		</div>
		...
		<div class="ps-lg-4 bankdemo-content text-center">		
			...
			<br>
			<span class="form-label fs-6 "><fmt:message key = "loanPayResults.submitted.message" bundle = "${messageProperties}"/></span>
			<br>
			<span class="form-label fs-6 "><fmt:message key = "loanNumber" bundle = "${messageProperties}"/>:
			...
			<span class="form-label fs-6 ">
				<fmt:message key = "loanPaymentNumber" bundle = "${messageProperties}"/>: </span>
				<span class="form-label fs-6 span-highlight">
					<strong>
						${loanPaymentNumber }
					</strong>				
		...
		<a href="/loans" style="width: 150px" class="btn btn-primary bankdemo-buton-primary"><fmt:message key = "forms.accept.message" bundle = "${messageProperties}"/></a>
		</div>				
	</main>
</div>
