...
<!--		<img class="mb-4" src="../include/img/bankdemologo.svg" alt="BankDemo"
			width="200" height="100" style="margin-top: 150px">-->
			<br>
			<span data-feather="check-circle"
				style="color: #00bb00; width: 100px; height: 100px; margin-top: 150px" /></span>
			<h5>			
			<fmt:message key = "forms.registerResult.registrationSuccessful.message" bundle = "${messageProperties}"/>
			</h5>
			<br>
			
			<h6>			
			<fmt:message key = "forms.registerResult.goBackToLogin.message" bundle = "${messageProperties}"/>
			</h6>
			<br>				
			<a href="/loginBegin" class="btn btn-lg btn-primary btn-primary-bankdemo" style="width: 150px">
