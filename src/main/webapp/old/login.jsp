...
<body class="text-center">
	...
	<main class="form-signin w-100 m-auto">
		<form action="<%= request.getContextPath()%>/home" method="post">
			...
			<h1 class="h3 mb-3 fw-normal">Login to services</h1>

			<div class="form-floating">
				<input type="text" class="form-control" id="floatingInput"
					placeholder="username" name="userName"> <label for="floatingInput">Username</label>
			</div>
			<div class="form-floating">
			...
			<button class="w-100 btn btn-lg btn-primary btn-primary-bankdemo" type="submit">Log In</button>			
		</form>
