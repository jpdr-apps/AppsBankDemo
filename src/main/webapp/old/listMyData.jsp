...
<div>
	<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
		...
		<div class="ps-lg-4 bankdemo-main-accordion">
			<form:form action="/myData" method="post"
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col">
							<form:input path="passwordCurrent" type="text" class="form-control"
								id="floatingInput" />

							<form:label path="passwordCurrent" for="floatingInput"
								class="form-label"
								style="display:block; width:x; height:y; text-align:left;">
							...
							<form:errors path="passwordCurrent"
								cssStyle="color:Red; display:block; width:x; height:y; text-align:left;" />
							<br>
				...
				<a href="/login" class="btn btn-lg btn-primary btn-primary-bankdemo"
...
<!-- Modal -->
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: block;">
